...
export const APP_VERSION = 'poc-24';
export const DEFAULTS = {
  ...
  // 横向きに立てかけるときは、頭が肩の線より下(0 未満)のときだけ「伏せている」とする。
  // 伏せる:8・10 回目 −0.75〜−0.27(9・11 回目は上半身が映らず、髪で判定)。
  // 顔を机に近づけて読む:11 回目 −0.23〜0.17、自由学習(27 分)0.03〜0.41 で、0.5 では伏せた居眠りと誤判定した
  headLowRatioLandscape: 0,
  ...
  eyeDeskAlertSec: 20,
  // 姿勢の通知の時間の計測で、この秒数以内の途切れは続いているとみなす(自由学習:顔を近づけると顔の検出がちらつき、
  // 20 秒の計測がやり直しになって「近すぎ」を一度も通知できなかった)
  postureGapSec: 3,
