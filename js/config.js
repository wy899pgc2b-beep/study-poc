...
export const DEFAULTS = {
  ...
  // 【記録のみ】自由に学習(メガネ・バックカメラ):起きて読み書きしているだけで、この方法で閉眼と判定されたフレームが 3 割近くあり、
  // 居眠り 5 回・うとうと 13 回の誤報になった(誤報の直前に閉眼と判定された秒数の 9 割がこの方法)。読むときの値(EAR 比 0.64〜1.00、閉じ具合 0.12〜0.34)と
  // 8 回目の前に傾いて目を閉じたときの値(0.57〜0.71、0.32〜0.38)が重なっていて、しきい値では分けられない。判定には使わず、記録だけする
  usePersonalClosed: false,
  personalCloseScore: 0.5,
