...
export const DEFAULTS = {
  ...
  drowsyClosedSec: 3,
  sleepClosedSec: 10,
  // 目を閉じていると判定された 10 秒のうち、書いていた時間がこの割合以上なら居眠りにしない(手が書く速さで動いている人は起きている。
  // 自由に学習(8 回目の前):書いている最中に 3 回、居眠りと誤判定した。手を止めて目を閉じたときに「書く」と出るのは 1 割程度。7 回目)
  sleepMaxWriteShare: 0.5,
  perclosWindowSec: 60,
  perclosDrowsy: 0.3,
  ...
  // 通知
  // 「うとうと」の音は、この秒数に 1 回まで(設計書 付録B の最小間隔 10 分。自由に学習で、判定がちらついて 1 秒以内に 2 回鳴った)。
  // 居眠りのアラームは間隔をあけない
  drowsyBeepMinSec: 600,
